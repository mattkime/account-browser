...
class Block extends Component {
    ...
    render() {
        ...
        return block && block.blockNumber ? (<table className="data_table">
            <tbody>
                <tr><td>Block Number</td><td>{block.blockNumber}</td></tr>
                <tr><td>Miner</td><td><Link to={`/address/${block.blockMiner}`}>{block.blockMiner}</Link></td></tr>
                <tr><td>Reward</td><td>{valToEthereum(block.blockReward)}</td></tr>
            </tbody>
        </table>) : null;
    }
}
